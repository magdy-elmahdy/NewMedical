...
const routes: Routes = [
  ...
  {path:'UploadGroupFile/:id/:type',canActivate:[HasRoleGuard],data:["Permissions.Offers.Create"],component:UplaodGroupFileComponent},
  {path:'Calculations/:id/:type',component:CalculationsOfPolicyComponent},
