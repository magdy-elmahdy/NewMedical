...
export class PolicyDetailssComponent {
  ...
  constructor(private _ToastrService:ToastrService,private _DatePipe:DatePipe, private _AdminService:AdminService,private _PolicyService:PolicyService,private _Router:Router,private _ActivatedRoute:ActivatedRoute ,private _AppendixService:AppendixService){
