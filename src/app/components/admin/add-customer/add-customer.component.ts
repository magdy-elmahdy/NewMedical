...
export class AddCustomerComponent implements OnInit{
  ...
  constructor(private _PolicyService:PolicyService, datePipe: DatePipe,public _TranslateService:TranslateService,private _ListsService:ListsService,private _AdminService:AdminService ,private _ToastrService:ToastrService, private _Router:Router){
...
checkBirthDate(){
    ...
    if(this.currentDate>=this.birthdayDate&&!isNaN(this.birthdayDate?.getTime())){
      ...
      }else if (this.SwitDOBOrIssueDate == 'DateOfEstablishmnet'){
        this._ToastrService.show('','Please Enter Correct Establishmnet Date')
      }
      else{
