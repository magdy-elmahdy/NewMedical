...
export class AllCustomersComponent implements OnInit{
  ...
  constructor(private _PolicyService:PolicyService,private _DatePipe:DatePipe,private _AuthService:AuthService,private _ListsService:ListsService ,private _AdminService:AdminService ,private _ActivatedRoute:ActivatedRoute ,private _ToastrService:ToastrService){
...
getCustomerTypeValue(e:any){
  ...
  if(this.CustomerTypeValue == 'Individual'){ // Individual
    ...
    this.Form.get('authorityEnd')?.clearValidators()
    this.Form.get('authorityEnd')?.updateValueAndValidity()
  }else if(this.CustomerTypeValue == 'TPA'){ // TPA
    // this.LabelId='Reg No.'
    $('#taxNom').show(300)
    $('#taxExpiryDate').show(300)
    // this.CustomMax=''
