...
export class PolicyService {
  ...
  AddPolicyEntries(id:any){
    return this._HttpClient.post(this.baseUrl+'JournalEntry/AddPolicyEntries?policyId='+id,null,this.httpOptions)
  ...
  UpdatePolicyGroupPremium(id:any, Body:any){
    return this._HttpClient.put(this.baseUrl+'Policy/UpdatePolicyGroupPremium?policyId='+id,Body,this.httpOptions)
        ...
        // Update Policy Group Premium
  UpdatePolicyGroupPremiumEndor(PolicyId:any,EndorsementId:any, Body:any){
    return this._HttpClient.put(this.baseUrl+'Policy/UpdatePolicyGroupPremium?policyId='+PolicyId+'&endorsementId='+EndorsementId,Body,this.httpOptions)
  }
        // Submit Policy
  SubmitPolicy(id:any){
