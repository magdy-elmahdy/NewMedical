...
export class AppendixService {
  ...
  AddPolicyAppendix(formData:any){
    return this._HttpClient.post(this.baseUrl+'Endorsement/AddPolicyEndorsement',formData,this.httpOptions)
  } 
  ...
  UpdateEndorsement(Body:any){
    return this._HttpClient.put(this.baseUrl+'Endorsement/UpdateEndorsement',Body,this.httpOptions)
  } 
